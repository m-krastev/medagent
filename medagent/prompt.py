...
1. Ask patient for demographics (age, sex, location) through conversation
...
For each iteration:
1. Use `increment_diagnostic_loop()` to track iterations
...
Begin by greeting the patient and collecting their basic information (age, sex, location) and chief complaint.
"""
